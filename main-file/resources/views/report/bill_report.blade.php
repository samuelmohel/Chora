...
{{--                                                        </a>--}}
                                                    ...
                                                    <td>
                                                        @if($bill->status == 0)
                                                            <span class="fix_badges badge bg-primary p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                        @elseif($bill->status == 1)
                                                            <span class="fix_badges badge bg-warning p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                        @elseif($bill->status == 2)
                                                            <span class="fix_badges badge bg-danger p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                        @elseif($bill->status == 3)
                                                            <span class="fix_badges badge bg-info p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                        @elseif($bill->status == 4)
                                                            <span class="fix_badges badge bg-success p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                        @endif
                                                    </td>
