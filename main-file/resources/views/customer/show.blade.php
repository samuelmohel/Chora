            ...
            <div class="card customer-detail-box customer_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">
                        {{ $customer['billing_city'] . ', ' . $customer['billing_state'] . ', ' . $customer['billing_zip'] }}</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($proposal->status == 0)
                                                <span
                                                    class="badge bg-primary p-2 px-3 fix_badge ">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                            @elseif($proposal->status == 1)
                                                <span
                                                    class="badge bg-warning p-2 px-3 fix_badge">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                            @elseif($proposal->status == 2)
                                                <span
                                                    class="badge bg-danger p-2 px-3 fix_badge">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                            @elseif($proposal->status == 3)
                                                <span
                                                    class="badge bg-info p-2 px-3 fix_badge">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                            @elseif($proposal->status == 4)
                                                <span
                                                    class="badge bg-success p-2 px-3 fix_badge">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                            @endif
                                        </td>
                                        @if (Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal'))
                                            <td class="Action">
                                                        ...
                                                        @if ($proposal->converted_invoice_id == 0)
                                                            @can('convert retainer proposal')
                                                                <div class="action-btn me-2">
                                                                    ...
                                                                    <a href="#"
                                                                        class="mx-3 btn btn-sm align-items-center bs-pass-para bg-brown-subtitle"
                                                            ...
                                                            @can('convert retainer proposal')
                                                                <div class="action-btn me-2">
                                                                    <a href="{{ route('retainer.show', \Crypt::encrypt($proposal->converted_retainer_id)) }}"
                                                                        class="mx-3 btn btn-sm  align-items-center bg-brown-subtitle"
                                                                        data-bs-toggle="tooltip"
                                                        ...
                                                        @if ($proposal->is_convert == 0)
                                                            @can('convert invoice proposal')
                                                                <div class="action-btn me-2">
                                                                    ...
                                                                    <a href="#"
                                                                        class="mx-3 btn btn-sm align-items-center bs-pass-para bg-warning-subtle"
                                                                        data-bs-toggle="tooltip"
                                                        ...
                                                        @can('show invoice')
                                                            <div class="action-btn me-2">
                                                                <a href="{{ route('invoice.show', \Crypt::encrypt($proposal->converted_invoice_id)) }}"
                                                                    class="mx-3 btn btn-sm  align-items-center bg-warning-subtle"
                                                                    data-bs-toggle="tooltip"
                                ...
                                @foreach ($customer->customerInvoice($customer->id) as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($invoice->status == 0)
                                                <span
                                                    class="badge bg-primary p-2 px-3 fix_badge">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                            @elseif($invoice->status == 1)
                                                <span
                                                    class="badge bg-warning p-2 px-3 fix_badge">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                            @elseif($invoice->status == 2)
                                                <span
                                                    class="badge bg-danger p-2 px-3 fix_badge">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                            @elseif($invoice->status == 3)
                                                <span
                                                    class="badge bg-info p-2 px-3 fix_badge">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                            @elseif($invoice->status == 4)
                                                <span
                                                    class="badge bg-success p-2 px-3 fix_badge">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                            @endif
                                        </td>
                                        @if (Gate::check('edit invoice') || Gate::check('delete invoice') || Gate::check('show invoice'))
                                            <td class="Action">
