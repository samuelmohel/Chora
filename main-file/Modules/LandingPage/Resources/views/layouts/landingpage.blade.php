                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 d-flex">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price">{{isset( $adminSettings['currency_symbol']) ? $adminSettings['currency_symbol'] : '$'  . \App\Models\Utility::formatPrice($value->price) }}<small
                                ...
                                <div class="d-grid">
                                        <a href="{{ route('register', ['value' => Crypt::encrypt($value->id), 'trial' => true]) }}" class="btn btn-primary ">Start with Starter <i data-feather="log-in" class="ms-2"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
