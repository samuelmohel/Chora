...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    // public function generateMonthlyEstateDuesInvoice()
    // {
    //     $estateDuesProduct = ProductService::where('name', 'Estate Dues')->where('created_by', $this->creatorId())->first();
    //     $invoice           = new Invoice();
    ...
    //     $invoice->due_date       = Carbon::now()->endOfMonth()->format('Y-m-d');
    //     $invoice->discount_apply = 0;
    //     $invoice->category_id    = 3;
    //     $invoice->created_by     = $this->creatorId();
    ...
    //     $invoiceProduct->product_id  = $estateDuesProduct?->id ?? 1;
    //     $invoiceProduct->quantity    = 1;
    //     $invoiceProduct->price       = $estateDuesProduct?->purchase_price ?? 8000;
    //     $invoiceProduct->description = "Estate Monthly Dues";
    //     $invoiceProduct->save();

    //     Utility::starting_number($invoice_number + 1, 'invoice');
