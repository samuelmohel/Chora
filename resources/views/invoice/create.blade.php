...
@push('script-page')
    ...
    <script>
        ...
        var submitForm = function(evt){
            ...
            var val = $('#customer').val(formCustomerID);
        ...
        $(document).on('change', '#customer', function() {
            ...
            // var id = Object.keys(customers).find(key => {
            //     // const split = customers[key];
            
            //     const split = customers[key].split(" ")[0];
            ...
            $(this).val(customers[id]);
            
            console.log('cusomer id', id, value);
...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'invoice', 'class' => 'w-100 needs-validation', 'novalidate', 'id' => 'form']) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <input required data-url={{ route('invoice.customer') }} class="form-control select"
                                    type="text" list="customer_list" id="customer" name="customer_id">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0 flex-nowrap">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control  item', 'data-url' => route('invoice.product'), 'required' => 'required']) }}
                                    </td>
                                    <td>
