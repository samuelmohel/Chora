...
@section('action-btn')
    <div class="d-flex">
        @can('create invoice')
            <a href="{{ route('invoice.generateMonth') }}" data-url="" data-title="Generate Monthly Invoice"
                class="btn btn-sm me-2 btn-primary ">Generate Invoices</a>
        @endcan
        @can('create invoice')
            <a href="{{ route('invoice.autoInvoice') }}" data-url="" data-title="Toggle Automatic Invoice"
                class="btn btn-sm me-2 {{ $autoInvoice->value == 0 ? 'btn-primary' : 'btn-danger' }}">Turn
                {{ $autoInvoice->value == 0 ? 'on' : 'off' }} Auto Invoice</a>
        @endcan
        @can('create invoice')
            <a href="#" data-size="md" data-bs-toggle="tooltip" title="{{ __('Import') }}"
                data-url="{{ route('invoice.file.import') }}" data-ajax-popup="true"
                data-title="{{ __('Import invoice CSV file') }}"
                class="btn btn-sm btn-primary me-2 d-flex justify-content-center align-content-center">
                <i class="ti ti-file-import"></i>
            </a>
        @endcan

        <a href="{{ route('invoice.export') }}"
            class="btn btn-sm btn-primary me-2 d-flex justify-content-center align-content-center" data-bs-toggle="tooltip"
            title="{{ __('Export') }}">
        ...
        @can('create invoice')
            <a href="{{ route('invoice.create', 0) }}"
                class="btn btn-sm btn-primary d-flex justify-content-center align-content-center" data-bs-toggle="tooltip"
                title="{{ __('Create') }}">
