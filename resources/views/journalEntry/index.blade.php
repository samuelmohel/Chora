...
@section('action-btn')
    <div class="float-end" style="display: flex; flex-flow: row nowrap;">
        @can('create journal entry')
            <a href="#" data-size="md" data-bs-toggle="tooltip" title="Import"
                data-url="{{ route('journal.file.import') }}" data-ajax-popup="true"
                data-title="{{ __('Import journal CSV file') }}"
