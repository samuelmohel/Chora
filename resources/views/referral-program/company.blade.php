                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($transaction->status == 0)
                                                            <span
                                                                class="status_badge badge bg-danger p-2 px-3 fix_badges">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 1)
                                                            <span
                                                                class="status_badge badge bg-warning p-2 px-3 fix_badges">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 2)
                                                            <span
                                                                class="status_badge badge bg-primary p-2 px-3 fix_badges">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @endif
                                                    </td>
