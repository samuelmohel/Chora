    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                @if (\Auth::guard('customer')->check())
                    <li class="dash-item">
                        <a href="{{ route('customer.my-statement', ['id' => \Auth::user()->id]) }}"
                            class="dash-link {{ Request::route()->getName() == 'customer.my-statement' ? ' active' : '' }}">
                            <span class="dash-micon"><i class="ti ti-receipt"></i></span>
                            <span class="dash-mtext">My Statement</span>
                        </a>
                    </li>
                @endif

                @if (Gate::check('manage customer proposal') && !\Auth::guard('customer')->check())
                    <li
                ...
                @if (Gate::check('manage customer'))
                    <li class="dash-item {{ Request::segment(1) == 'customer' ? 'active' : '' }}">
                        <a href="{{ route('customer.index') }}" class="dash-link ">
                            ...
                            <span class="dash-mtext">{{ __('Resident') }}</span>
                        </a>
                    </li>
                @endif
...
@endif -->
                ...
                @if (Gate::check('manage proposal') || (Gate::check('manage retainer') && !\Auth::guard('customer')->check()))
                    <li
                        ...
                        <ul
                            ...
                            @can('trial balance report')
                                <li
                                    ...
                                    <a class="dash-link"
                                        href="{{ route('report.profit.loss.summary') }}">Profit & Loss Summary</a>
                                </li>
                            @endcan
                            @can('trial balance report')
                                <li
                                    ...
                                    <a class="dash-link"
                                        href="{{ route('report.profit.loss') }}">Profit & Loss Report</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                @if (Gate::check('manage contract') && !\Auth::guard('customer')->check())
                ...
                @can('manage customer contract' && !\Auth::guard('customer')->check())
