    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{ Form::label('resident_id', __('Apartment ID'), ['class' => 'form-label']) }}<x-required></x-required>
                <div class="form-icon-user">
                    {{ Form::text('resident_id', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Apartment ID')]) }}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
        ...
        <x-mobile div-class="col-md-4 " name="contact" label="{{ __('Contact') }}"
            placeholder="{{ __('Enter Contact') }}" required></x-mobile>
