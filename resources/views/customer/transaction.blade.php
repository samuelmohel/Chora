    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" multi-collapse mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['customer.transaction'], 'method' => 'GET', 'id' => 'frm_submit']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('category', ['' => 'Select Category'] + $category, isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select']) }}
                                        </div>
                                    </div>
                            ...
                            <div class="col-auto mt-3">
                                <div class="row">
                                    <div class="col-auto d-flex">
                                        ...
                                        <a href="{{ route('customer.transaction') }}" class="btn btn-sm btn-danger"
