...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('minimum_purchase', 'Minimum Purchase Value', ['class' => 'form-label']) }}
                <div class="form-icon-user">
                    {{ Form::number('minimum_purchase', null, ['class' => 'form-control', 'step' => '1',  'placeholder' => 'Minimum Purchase Value']) }}
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('price_type', 'Pricing Type', ['class' => 'form-label']) }}
                <div class="form-icon-user">
                    <select name="price_type" class="form-control">
                        <option value='fixed' {{$productService?->price_type == 'fixed' ? 'selected' : ''}}>Fixed</option>
                        <option value='flexible' {{$productService?->price_type == 'flexible' ? 'selected' : ''}}>Flexible</option>
                    </select>
                </div>
            </div>
        </div>
