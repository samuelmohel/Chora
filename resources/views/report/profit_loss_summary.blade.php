    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
               href="{{ route('report.profit.loss.summary') }}"
               onclick="window.location.href = '{{ route('report.profit.loss.summary') }}'" role="tab"
               aria-controls="pills-profile" aria-selected="false">{{ __('Quarterly') }}</a><!-- used to be report.monthly.purchase -->
        </li>
    </ul>
